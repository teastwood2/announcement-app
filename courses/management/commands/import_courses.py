...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        with open(csv_file, newline = '') as file:
            ...
            for row in reader:
                course, created = Course.objects.get_or_create(title = row['title'], description = row['description'])
        self.stdout.write(self.style.SUCCESS('Course Created Successfully from "%s"' % csv_file))